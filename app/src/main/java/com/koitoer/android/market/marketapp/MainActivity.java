...
import com.koitoer.android.market.marketapp.di.component.ActivityComponent;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> Snackbar.make(view,
                "Replace with your own action" + productRepository.getTableInformation(), Snackbar.LENGTH_LONG)
